...
export default function Privacybeleid() {
  ...
  return (
    <>
      <Head>
          <title>Stukadoorsbedrijf Ince - Privacybeleid</title>
          <meta name="description" content="Lees het privacybeleid van Stukadoorsbedrijf Ince. Wij beschermen uw persoonsgegevens en leggen uit hoe wij uw gegevens verzamelen, gebruiken en beveiligen."/>
          <meta name="og:description" content="Lees het privacybeleid van Stukadoorsbedrijf Ince. Wij beschermen uw persoonsgegevens en leggen uit hoe wij uw gegevens verzamelen, gebruiken en beveiligen."/>
          <meta name="keywords" content="privacybeleid, persoonsgegevens, gegevensbescherming, Stukadoorsbedrijf Ince, privacy"/>
          <meta property="og:url" content="https://www.stukadoorsbedrijfince.nl/privacybeleid"/>
          <meta property="og:title" content="Stukadoorsbedrijf Ince - Privacybeleid"/>
      </Head>


      <div className="pagehero privacybeleid">
        <div>
          <div>
            <section>
              <h1>Privacybeleid</h1>
      ...
      <div className="pagelayout policy">
        <div>

          <div>
            <section>
                <p><b>Ingangsdatum: 22 mei 2024</b></p>
                <p>Bij Stukadoorsbedrijf Ince hechten wij veel waarde aan de bescherming van uw persoonsgegevens. Dit privacybeleid legt uit welke gegevens wij verzamelen, hoe wij deze gebruiken, en hoe wij uw privacy waarborgen.</p>
                
                <h2>1. Welke gegevens verzamelen wij?</h2>
                <p>Wij verzamelen de volgende persoonsgegevens:</p>
                <h3>Via het contact- en offerteformulier:</h3>
                <ul>
                    <li>Naam</li>
                    <li>E-mailadres</li>
                ...
                <h3>Contact- en offerteformulier:</h3>
                <p>De gegevens die u via het contact- en offerteformulier verstrekt, worden naar ons e-mailadres gestuurd. Wij gebruiken deze gegevens uitsluitend om uw aanvraag te verwerken, contact met u op te nemen, en u van de gevraagde informatie te voorzien.</p>
                ...
                <p>De gegevens die via het contact- en offerteformulier naar ons worden gestuurd, worden bewaard in onze e-mailinbox zolang als nodig is om uw aanvraag te verwerken en om aan onze wettelijke verplichtingen te voldoen.</p>
                ...
                <ul>
                  <li>Stukadoorsbedrijf Ince</li>
                  <li>E-mailadres: <Link href="mailto:info@stukadoorsbedrijfince.nl">info@stukadoorsbedrijfince.nl</Link></li>
                  <li>Telefoonnummer: 06 48 03 33 74</li>
                  <li>Adres: Kralingen 124 1566CC Assendelft Nederland</li>
                </ul>
