...
export default function StukadoorWormer() {
  useEffect(() => {
  });
  ...
  return (
    <>
      <Head>
        <title>Stukadoorsbedrijf Ince - Stukadoor Wormer</title>
        <meta name="description" content="Op zoek naar een ervaren stukadoor in Wormer? Stukadoorsbedrijf Ince biedt hoogwaardige stucwerk diensten voor woningen en bedrijven in Wormer en omgeving."/>
        <meta name="og:description" content="Op zoek naar een ervaren stukadoor in Wormer? Stukadoorsbedrijf Ince biedt hoogwaardige stucwerk diensten voor woningen en bedrijven in Wormer en omgeving."/>
        <meta name="keywords" content="stukadoor Wormer, stukadoorsbedrijf Wormer, stucwerk Wormer, muren stucen Wormer, plafond stucen Wormer"/>
        <meta property="og:url" content="https://www.stukadoorsbedrijfince.nl/stukadoor-wormer/"/>
        <meta property="og:title" content="Stukadoorsbedrijf Ince - Stukadoor Wormer"/>
      </Head>
  
      <div className="pagehero wormer">
        <div>
          <div>
            <section>
              <h1>Stukadoor Wormer</h1>
              <ul className="breadcrumb">
                <li><Link href="/">Home</Link></li>
                <li>Stukadoor Wormer</li>
              </ul>
            </section>
          </div>
        </div>
      ...
      <div className="pagelayout">
        <div>
          <div>
            <section>
              <h2>Ervaring en Vakmanschap in Wormer</h2>
              <p>Welkom bij Stukadoorsbedrijf Ince, uw professionele partner voor stucwerk in Wormer en omgeving. Met onze uitgebreide ervaring en vakmanschap bieden wij hoogwaardige afwerkingen voor muren en plafonds. Of het nu gaat om een renovatieproject of een nieuwbouwwoning, wij streven naar perfectie en klanttevredenheid.</p>
      ...
      <div className="pagelayout">
        <div>
          <div>
            <section>
              <h2>Waarom Kiezen voor Stukadoorsbedrijf Ince in Wormer?</h2>
